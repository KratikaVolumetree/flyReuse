...
//  flyReuse
//
//  Created by VOLUMETREE on 20/09/23.
//
...
public class Country {
    ...
    var extentionCode: String?
    var flag: String?
}

public class CountryVC: UIViewController {
    ...
    public func configuration() {
        for code in NSLocale.isoCountryCodes {
            ...
            if name != nil {
                ...
                model.extentionCode = NSLocale().extensionCode(countryCode: model.countryCode)
                list.append(model)
            }
        }
...
//        cell.textLabel?.text = "\(String(describing: duplist[indexPath.row].flag)) \(String(describing: duplist[indexPath.row].name))"
...
extension NSLocale {
    public func extensionCode(countryCode : String?) -> String? {
